...
@CjService(name = "wenyBankTradeService")
public class WenyBankTradeService implements IWenyBankTradeService {
    ...
    private void addPriceBill(PurchaseRecord record) {
        ...
        try {
            priceBill.setSn(new IdWorker(1).nextId() + "");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void addStockBill(PurchaseRecord record) {
        ...
        try {
            stockBill.setSn(new IdWorker(1).nextId() + "");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void addFreeBill(PurchaseRecord record) {
        ...
        try {
            freeBill.setSn(new IdWorker(1).nextId() + "");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void addFreezenBill(PurchaseRecord record) {
        ...
        try {
            freezenBill.setSn(new IdWorker(1).nextId() + "");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void addFundBill(PurchaseRecord record) {
        ...
        try {
            fundBill.setSn(new IdWorker(1).nextId() + "");
        } catch (Exception e) {
            e.printStackTrace();
        }
